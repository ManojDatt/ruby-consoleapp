===========================================   Arka ROR Team =========================================
Instruction to use start.rb script

1) Please install the following gems
gem pristine byebug --version 9.0.6 , gem pristine debug_inspector --version 0.0.2,
gem install highline, and gem install cli-console

2) Run the script with $ ruby start.rb
3) You get a console with following commands

 a)  ls - List files
 b)  pwd - Current directory
 c)  cd - Change directory
 d)  start - Calculate Rank
 e)  help - Help
 f)  exit - Exit from program
 g)  quit - alias to "exit"
